...
> No hands-on yet — everything in this module is whiteboard / slides / discussion. The first deploy happens in [Module 2](./2-Deploy-Agent.md).
...
- **Why incidents take too long to resolve.** Where does *your* MTTR actually go — detection, triage, RCA, fix, comms?
...
Open-ended versions of the discussion points above. Pick 2–3 based on the room.

- *"What slows your team down during incidents today?"* — usually surfaces tooling sprawl and access bottlenecks.
- *"Which tools do you switch between most often during an investigation?"* — maps directly to the Integrations table above.
- *"What knowledge is usually trapped in past incidents?"* — leads into the memory discussion.
- *"What's the smallest action you'd be willing to let an agent take unattended?"* — primes Module 4's guardrail conversation.
- *"If your best on-call engineer left tomorrow, what would you lose?"* — primes the *Knowledge that never leaves* slide for [Bonus](./Bonus.md).
...
- [Azure SRE Agent — Overview](https://learn.microsoft.com/azure/sre-agent/overview) — official feature catalog.
